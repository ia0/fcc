...
\infer[JTBSnd]{%
  ...
  \JT \Ha {\TSnd {\TPair \ta \tb}} \tb \KStar
}

\infer[JTEProd]{%
  \JT \Ha \ta \ta \KProd \kai \kaii
}{%
  \JT \Ha \ta {\TPair {\TFst \ta} {\TSnd \ta}} \KProd \kai \kaii
}
